...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "sun'iy intellekt video", 'ai video montaj', 'ai video tahrirlash',
    ...
    "chatgpt o'zbekcha", 'chatgpt darslari', 'chatgpt bepul kurs',
    "midjourney o'zbekcha", 'midjourney darslari', 'midjourney bepul',
    ...
    "sun'iy intellekt asboblar", 'ai vositalar bepul', 'eng yaxshi ai vositalar',
    'sancho ai', 'sanchoyt', 'sancho kurslar', 'sancho ai akademiya',
    'onlayn ai kursi', "bepul onlayn ta'lim", 'ai akademiya',
    "sun'iy intellekt ovoz", "ovoz o'zgartirish ai",
    'elevenlabs darslari', 'elevenlabs bepul', 'ai dublyaj',
    'comfyui darslari', 'comfyui bepul',
    "kling ai o'zbekcha", 'runway ai darslari', 'heygen darslari',
    "yuz o'zgartirish ai", 'deepfake ai', "ai portret rasm",
    ...
    '#SuniyIntellekt', '#AIkursi', '#BepulAI', '#AIvideo', '#PromptYozish',
    '#ChatGPTOzbekcha', '#MidjourneyDarslari', '#AIAvatar', '#OvozKlonlash',
    '#TekinAI', '#AIAkademiya', '#SanchoAI', '#Sanchoyt', '#AIBilan',
    '#ReelsYaratish', '#ShortsAI', '#AIDarslari', '#BepulKurs', '#AIUzbek',
    ...
    'создание видео с ИИ', 'ИИ видео курс', 'как создать видео с ИИ',
    'ИИ видео генерация', 'ИИ монтаж видео', 'видео с искусственным интеллектом',
    'клонирование голоса ИИ', 'ИИ голос бесплатно', 'генерация голоса ИИ',
    'ИИ аватар', 'создание аватаров ИИ', 'цифровой аватар ИИ', 'ИИ аватар бесплатно',
    'генерация изображений ИИ', 'ИИ рисунок', 'ИИ арт бесплатно',
    'написание промптов', 'промпт инжиниринг', 'промпты для ИИ', 'промпты ChatGPT',
    ...
    'заработок с ИИ', 'монетизация ИИ', 'пассивный доход ИИ',
    'инструменты ИИ бесплатно', 'лучшие ИИ инструменты', 'ИИ инструменты 2024 2025',
